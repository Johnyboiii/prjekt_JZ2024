 ...
 */
final class Version20240515084610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks ADD category_id INT DEFAULT NULL, ADD many_to_one VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks DROP category_id, DROP many_to_one');
    }
}
